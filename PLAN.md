...
| `task-chatfix-101` | `ms-18` | Stabilize browser -> backend -> LM Studio transport path | Core Team | planned | Promote the new backend route from partial wiring to the authoritative chat transport path. |
