...
| :--- | :--- | :--- | :--- | :--- |
| `risk-voice-001` | Browser microphone permissions and local-runtime constraints may complicate the first voice implementation. | High | Medium | Design for browser-safe capture first; keep adapters isolated; use mocked or file-based audio for staged validation. |
