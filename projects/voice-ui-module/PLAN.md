...
| `task-voice-102` | `ms-voice-02` | Implement voice capture and interaction flow in the TypeScript UI | Jules | 5 | planned | Blocked on `task-voice-101`. Implementation must follow `ARCHITECTURE.md` and `REQUIREMENTS.md` in this module with no Python dependencies. |
