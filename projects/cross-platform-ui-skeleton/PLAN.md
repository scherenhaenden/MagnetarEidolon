...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `task-ui-101` | `ms-ui-01` | Define shared UI shell for Linux/macOS/Windows | UI Team | 5 | 38 | in_progress | Bootstrapped shell layout and route map. |
| `task-ui-102` | `ms-ui-01` | Define platform-specific adapter interfaces | UI Team | 3 | 23 | ready | Contracts outlined for OS integrations. |
| `task-ui-103` | `ms-ui-01` | Define navigation and state container skeleton | UI Team | 3 | 23 | planned | Will finalize after shell contract review. |
| `task-ui-104` | `ms-ui-01` | Create baseline UI testing scaffolding | UI Team | 2 | 15 | planned | Snapshot and smoke tests pending. |
