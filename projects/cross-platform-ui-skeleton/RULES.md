# Canonical Ruleset of Cross-Platform UI Skeleton

## Introduction
These rules codify the Magnetar standard for Cross-Platform UI Skeleton. The entire project must comply unless a formal exception is documented in `BITACORA.md`.
