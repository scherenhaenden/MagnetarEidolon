# Canonical Ruleset of System Interaction Module Skeleton

## Introduction
These rules codify the Magnetar standard for System Interaction Module Skeleton. The entire project must comply unless a formal exception is documented in `BITACORA.md`.
